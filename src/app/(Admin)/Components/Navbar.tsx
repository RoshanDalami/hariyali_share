        ...
        <Modal>
          <div className="flex items-center justify-center" role="dialog" aria-modal="true">
            <div className="bg-white h-28 rounded-md w-2/4">
              <h1 className="text-2xl font-bold text-center mt-5">Confirm logout?</h1>
              <div className="flex justify-center mt-4">
                <div className="flex gap-3">
                  <button
                    className="bg-gray-300 rounded-md px-4 py-2 text-white font-bold"
                    onClick={() => setShowModal(false)}
                  >
                    Cancel
                  </button>
                  <button
                    className="bg-red-600 rounded-md shadow-md text-white px-4 py-2 font-bold"
                    onClick={handleLogoutFromAdmin}
                  >
                    Logout
                  </button>
                </div>
      ...
      <div className="flex fixed bg-white h-[88px] w-full z-10 border-b border-gray-300">
        <div className="flex items-center ml-12 gap-4">
          <Image
            ...
            width={200}
          />
          <p className="text-2xl text-green-600 font-bold">Hariyali Share</p>
        </div>
